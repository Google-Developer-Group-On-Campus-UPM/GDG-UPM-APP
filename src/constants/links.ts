...
const DEFAULT_LINKS = {
	...
	LINKEDIN_COMPANY: "https://www.linkedin.com/company/google-developer-groups-upm/",
	...
	FOOTER_COMMUNITY_MISSION: "/community/mission",
	FOOTER_COMMUNITY_EVENTS: "/community/events",
	FOOTER_COMMUNITY_TEAM: "/community/team",
	FOOTER_COMMUNITY_JOIN: "/community/join",
...
const ENV_LINKS = {
	COMMUNITY_PLATFORM:
		process.env.NEXT_PUBLIC_LINK_COMMUNITY_PLATFORM || DEFAULT_LINKS.COMMUNITY_PLATFORM,
	...
	LINKEDIN_COMPANY: process.env.NEXT_PUBLIC_LINK_LINKEDIN_COMPANY || DEFAULT_LINKS.LINKEDIN_COMPANY,
	GITHUB: process.env.NEXT_PUBLIC_LINK_GITHUB || DEFAULT_LINKS.GITHUB,
	GITHUB_ORG: process.env.NEXT_PUBLIC_LINK_GITHUB_ORG || DEFAULT_LINKS.GITHUB_ORG,
	...
	TEAMS: process.env.NEXT_PUBLIC_ROUTE_TEAMS || DEFAULT_LINKS.TEAMS,
	EVENTS: process.env.NEXT_PUBLIC_ROUTE_EVENTS || DEFAULT_LINKS.EVENTS,
	PARTNERS: process.env.NEXT_PUBLIC_ROUTE_PARTNERS || DEFAULT_LINKS.PARTNERS,
	ADMIN: process.env.NEXT_PUBLIC_ROUTE_ADMIN || DEFAULT_LINKS.ADMIN,
	LOGIN: process.env.NEXT_PUBLIC_ROUTE_LOGIN || DEFAULT_LINKS.LOGIN,
};
