...
import EventCardV2 from "../event-card-v2/EventCardV2";

interface EventCarouselV2Props {
  events: Event[];
...
/**
 * EventCarouselV2 Component - Built with EventCardV2
 *
 * A carousel component that displays EventCardV2 components in a horizontal scrolling layout.
 ...
 * <EventCarouselV2 events={eventList} />
 *
 * @example
 ...
 * />
 */
export default function EventCarouselV2({
  events = [],
  eventsPerPage = 3,
  showGetTicket = false,
  onGetTicketClick,
