...
const AnnouncementSection: React.FC = () => {
    return (
        <div className="min-h-screen w-full bg-black flex justify-center items-center relative z-0">
            ...
            />
            <div className="mx-4 md:mx-16 lg:mx-32 xl:mx-64 grid grid-cols-1 md:grid-cols-2 grid-rows-[0.2fr_1fr] gap-x-10 gap-y-5 items-center max-w-screen-xl w-full">
                ...
                <div className="row-start-3 col-start-1 md:row-start-2 md:col-start-2 self-start">
                    <div className="flex flex-col justify-between h-full space-y-8">
                        <p className="font-medium text-white text-center md:text-left text-[clamp(24px,2.5vw,48px)]">
                            “At GDG, We Commit to{" "}
                            <span className="font-black">
                                Advancing Theoretical Knowledge and Technical Skills”
                            </span>
                        </p>
                        <p className="text-white text-center md:text-left text-[clamp(14px,1.2vw,20px)]">
