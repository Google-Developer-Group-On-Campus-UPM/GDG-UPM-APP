            ...
            <div className="flex justify-center w-full">
              <div className="mt-32 sm:mt-40 md:mt-48 lg:mt-52 flex justify-center w-full">
                <div
                  ...
                  style={{
                    background: "linear-gradient(rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)) padding-box, linear-gradient(to right, rgba(255, 255, 255, 0.2), rgba(66, 133, 244, 0.2)) border-box"
                  }}
                >
                  <Image
                  ...
                  <div className="pb-6 pr-6 pl-6">
                    <div className="flex items-center">
                      <Image
                        ...
                        height={26}
                      />
                      <span className="text-xl ml-2 font-medium">{card.title}</span>
                    </div>
